...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('start_time', models.DateTimeField(auto_now_add=True, verbose_name='время начала прохождения теста')),
                ('finish_time', models.DateTimeField(verbose_name='время окончания прохождения теста')),
            ],
            options={
